...
class CurlHook implements LibraryHook
{
    ...
    /**
     * @var array<int, array<resource>> all curl handles which belong to curl_multi handles
     */
    protected static $multiHandles = [];

    /**
     * @var array<resource> last active curl_multi_exec() handles
     */
    ...
    public static function curlGetinfo($curlHandle, int $option = 0)
    {
        ...
        if (\CURLINFO_PRIVATE === $option && !\in_array((int) $curlHandle, self::$responses, true)) {
